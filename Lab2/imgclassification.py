...
class ImageClassifier:
    ...
    def extract_image_features(self, data):
        ...
        feature_data = []
        for pixel in data:
            temp_pixel = color.rgb2gray(pixel)
            temp_pixel = filters.gaussian(temp_pixel, sigma=0.4)
            img_feature = feature.hog(temp_pixel, orientations=10, pixels_per_cell=(24,24), cells_per_block=(6,6), block_norm='L2-Hys', visualize=False, feature_vector=True, multichannel=False)
